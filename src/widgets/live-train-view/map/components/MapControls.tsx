  ...
  return (
    <div className="space-y-2">
      <div className="rounded-[8px] border border-gray-400 bg-white drop-shadow-sm">
        <button type="button" className="group p-2" onClick={handleZoomIn}>
        ...
        <button type="button" className="group p-2" onClick={handleZoomOut}>
          <Icons.Minus className="fill-navy-700 h-4 w-4 transition-all duration-150 group-hover:scale-110 group-active:scale-90" />
        </button>
      </div>

      <div className="rounded-[8px] border border-gray-400 bg-white drop-shadow-sm">
        <button type="button" className="group p-2" onClick={handleRecenter}>
